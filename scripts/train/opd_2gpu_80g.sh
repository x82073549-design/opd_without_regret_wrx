...
# Prune-OPD's dynamic rollout-budget controller.  Disabled by default so
# existing overlap-route experiments retain their original behavior.
export OVERLAP_ROUTE_DYNAMIC_LENGTH_ENABLE=${OVERLAP_ROUTE_DYNAMIC_LENGTH_ENABLE:-False}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_INITIAL=${OVERLAP_ROUTE_DYNAMIC_LENGTH_INITIAL:-1024}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_MIN=${OVERLAP_ROUTE_DYNAMIC_LENGTH_MIN:-1024}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_MAX=${OVERLAP_ROUTE_DYNAMIC_LENGTH_MAX:-$MAX_RESP_LENGTH}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_STEP=${OVERLAP_ROUTE_DYNAMIC_LENGTH_STEP:-100}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_MARGIN=${OVERLAP_ROUTE_DYNAMIC_LENGTH_MARGIN:-100}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_HIT_RATIO_THRESHOLD=${OVERLAP_ROUTE_DYNAMIC_LENGTH_HIT_RATIO_THRESHOLD:-0.1}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_SHRINK_PATIENCE=${OVERLAP_ROUTE_DYNAMIC_LENGTH_SHRINK_PATIENCE:-3}
export OVERLAP_ROUTE_DYNAMIC_LENGTH_EPSILON=${OVERLAP_ROUTE_DYNAMIC_LENGTH_EPSILON:-1e-6}
...
if [ "$OVERLAP_ROUTE_OPD_ENABLE" = "True" ]; then
    ...
    if [ "$OVERLAP_ROUTE_DYNAMIC_LENGTH_ENABLE" = "True" ]; then
        OVERLAP_ROUTE_ARGS+=(
            +algorithm.overlap_route_opd.dynamic_length.enable=True
            +algorithm.overlap_route_opd.dynamic_length.initial="$OVERLAP_ROUTE_DYNAMIC_LENGTH_INITIAL"
            +algorithm.overlap_route_opd.dynamic_length.min="$OVERLAP_ROUTE_DYNAMIC_LENGTH_MIN"
            +algorithm.overlap_route_opd.dynamic_length.max="$OVERLAP_ROUTE_DYNAMIC_LENGTH_MAX"
            +algorithm.overlap_route_opd.dynamic_length.step="$OVERLAP_ROUTE_DYNAMIC_LENGTH_STEP"
            +algorithm.overlap_route_opd.dynamic_length.margin="$OVERLAP_ROUTE_DYNAMIC_LENGTH_MARGIN"
            +algorithm.overlap_route_opd.dynamic_length.hit_ratio_threshold="$OVERLAP_ROUTE_DYNAMIC_LENGTH_HIT_RATIO_THRESHOLD"
            +algorithm.overlap_route_opd.dynamic_length.shrink_patience="$OVERLAP_ROUTE_DYNAMIC_LENGTH_SHRINK_PATIENCE"
            +algorithm.overlap_route_opd.dynamic_length.epsilon="$OVERLAP_ROUTE_DYNAMIC_LENGTH_EPSILON"
        )
    fi
fi
...
echo "  OVERLAP_ROUTE_DYNAMIC_LENGTH_ENABLE=$OVERLAP_ROUTE_DYNAMIC_LENGTH_ENABLE"
if [ "$OVERLAP_ROUTE_DYNAMIC_LENGTH_ENABLE" = "True" ]; then
    echo "  OVERLAP_ROUTE_DYNAMIC_LENGTH=initial:$OVERLAP_ROUTE_DYNAMIC_LENGTH_INITIAL min:$OVERLAP_ROUTE_DYNAMIC_LENGTH_MIN max:$OVERLAP_ROUTE_DYNAMIC_LENGTH_MAX step:$OVERLAP_ROUTE_DYNAMIC_LENGTH_STEP margin:$OVERLAP_ROUTE_DYNAMIC_LENGTH_MARGIN hit_ratio:$OVERLAP_ROUTE_DYNAMIC_LENGTH_HIT_RATIO_THRESHOLD patience:$OVERLAP_ROUTE_DYNAMIC_LENGTH_SHRINK_PATIENCE"
fi
